export class InfoPanel {
    constructor(app) {
        ...
        this.balanceText.y = app.screen.height - 50;
        ...
        this.betText.y = app.screen.height - 50;
        ...
        this.winText.y = app.screen.height - 50;
    ...
    updateBet(value) {
        this.betText.text = `Total Bet: ${value.toFixed(2)}`;
    }
